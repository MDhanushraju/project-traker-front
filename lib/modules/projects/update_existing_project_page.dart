...
/// Update Existing Project: select an old project and update it with what change
/// needs to be done, technologies, members, dates, etc. Same form as Add Small Change.
class UpdateExistingProjectPage extends StatefulWidget {
  const UpdateExistingProjectPage({super.key});

  @override
  State<UpdateExistingProjectPage> createState() => _UpdateExistingProjectPageState();
}

class _UpdateExistingProjectPageState extends State<UpdateExistingProjectPage> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Select a project, then enter what change needs to be done, technologies, and assign team members.',
            ...
            if (_selectedProject != null) ...[
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'What change need to be done',
                  hintText: 'Describe the change required, scope, and deliverables...',
  ...
  void _showProjectPicker(BuildContext context) {
    ...
    if (projects.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('No projects available to update')),
      );
      return;
    }
    showModalBottomSheet<ProjectModel>(
      context: context,
