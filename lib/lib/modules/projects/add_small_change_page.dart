...
/// Add Small Change: same as Add New Project but uses "What change need to be done"
/// instead of Description. Keeps Technologies, members, dates, etc.
class AddSmallChangePage extends StatefulWidget {
  const AddSmallChangePage({super.key});

  @override
  State<AddSmallChangePage> createState() => _AddSmallChangePageState();
}

class _AddSmallChangePageState extends State<AddSmallChangePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Add Small Change'),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Add a small change to a project',
            ...
            Text(
              'Enter project name, what change needs to be done, technologies, and assign team members.',
  ...
  void _onCreate() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Small change "$name" added')),
    );
